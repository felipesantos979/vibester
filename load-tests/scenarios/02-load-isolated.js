 ...
 * auth, user, event. post-service e feed-service ficam de fora (dependem do
 * Astra/Cassandra externo), e establishment-service (depende de bucket R2) —
 * nenhum isolável via k8s puro.
 *
